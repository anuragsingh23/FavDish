...
class RandomDishFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
         ...
         */
        mBinding!!.srlRandomList.setOnRefreshListener {
    ...
    private fun randomDishViewModelObserver() {
        ...
        mRandomDishViewModel.randomDishResponse.observe(
            ...
            Observer { randomDishResponse ->
                randomDishResponse?.let {
                    ...
                    if (mBinding!!.srlRandomList.isRefreshing) {
                        mBinding!!.srlRandomList.isRefreshing = false
                    }
        ...
        mRandomDishViewModel.loadRandomDish.observe(viewLifecycleOwner, Observer { loadRandomDish ->
            loadRandomDish?.let {
                ...
                if (loadRandomDish && !mBinding!!.srlRandomList.isRefreshing) {
